...
public class AndroidHideApiHelper {
    ...
    public static int bypass(Context context) {
        ...
        if (bypassByFile(context)) {
            return 0;
        }
        return -1;
    }

    private static boolean bypassByFile(Context context) {
        ...
        try {
            ...
            Class<?> bootstrapClass = dexFile.loadClass(CustomBootClass.class.getCanonicalName(), null);
            Method exemptAll = bootstrapClass.getDeclaredMethod("bypassAllHide");
